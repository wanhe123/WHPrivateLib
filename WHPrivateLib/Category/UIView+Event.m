...
//	objc_setAssociatedObject(self, @selector(enableEvent), @(enableEvent), OBJC_ASSOCIATION_COPY_NONATOMIC);
//}
//
//-(BOOL)enableEvent {
...
//}
//
//-(void)setTouchBlock:(void (^)(UIView *, MGGestureRecognizerState, NSSet *, UIEvent *))touchBlock {
//		[self aspect_hookSelector:@selector(touchesEnded:withEvent:) withOptions:AspectPositionAfter usingBlock:^(id<AspectInfo>info,NSSet *touches,UIEvent *event){
//			if(self.enableEvent){
//				NSLog(@"touchesBegan:withEvent:");
//				touchBlock(self,MGGestureRecognizerStateEnded,touches,event);
//			}
//		} error:NULL];
//	objc_setAssociatedObject(self, @selector(setTouchBlock:), touchBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
//}
//
//-(void (^)(UIView *,MGGestureRecognizerState,NSSet *,UIEvent *))touchBlock{
